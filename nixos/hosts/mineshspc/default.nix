{ pkgs, ... }:
let
  minesHSPCDataDir = "/var/lib/mineshspc";
in
{
  ...
  deployment.keys = {
    mineshspc_env.keyCommand = [
      "cat"
      "secrets/mineshspc_env"
    ];
    restic_password_file.keyCommand = [
      "cat"
      "secrets/restic_password_file"
    ];
    restic_environment_file.keyCommand = [
      "cat"
      "secrets/restic_environment_file"
    ];
  };
  ...
  systemd.network.networks = {
    ...
    "10-nevarronet" = {
      matchConfig.MACAddress = "86:00:00:3a:eb:6a";
    };
  };
  ...
  systemd.services =
    let
      ...
      unsubstituted = yamlFormat.generate "mineshspc.com.unsubstituted.config" siteConfig;
    in
    {
  ...
  services.backup = {
    backupCompleteURL = "https://heartbeat.uptimerobot.com/m798927779-61646bda63fc510bcc1c1db7d12c2ab067e9d2eb";
    pruneCompleteURL = "https://heartbeat.uptimerobot.com/m798927806-16cf1c565d3b00c18818acca77df8fa81352a95e";
    backups.mineshspc.path = minesHSPCDataDir;
  };

  services.healthcheck = {
    enable = true;
    url = "https://heartbeat.uptimerobot.com/m798927178-0ebe5c13b70802d93227618c51f24b88ab4cb9d6";
    disks = [
      {
        path = "/";
        threshold = 95;
        url = "https://heartbeat.uptimerobot.com/m798927657-92bfbbf168e47d51043c596f53e73b2df7d1e57a";
      }
    ];
  };
}
